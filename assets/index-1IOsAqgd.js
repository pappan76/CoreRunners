 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VM=new Pe(K.comparator);function tn(){return VM}const sP=new Pe(K.comparator);function ll(...n){let e=sP;for(const t of n)e=e.insert(t.key,t);return e}function oP(n){let e=sP;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Xn(){return Al()}function aP(){return Al()}function Al(){return new Mi(n=>n.toString(),(n,e)=>n.isEqual(e))}const OM=new Pe(K.comparator),LM=new Ie(K.comparator);function oe(...n){let e=LM;for(const t of n)e=e.add(t);return e}const MM=new Ie(se);function Ay(){return MM}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
